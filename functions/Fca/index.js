...
function buildAPI(globalOptions, html, token, jar) {
  ...
  if (token == 'NONE') 
    ...
    console.log(`Cant get access_token`);
  if (oldFBMQTTMatch) {
    ...
    if (newFBMQTTMatch) {
      ...
      if (legacyFBMQTTMatch) {
        ...
        region = new URL(mqttEndpoint).searchParams.get("region").toUpperCase();
      console.log(`Your account has been disconnected. Please check your Facebook account to see if anything has happened.`);
    ...
    return utils
      ...
      .then(function(res) {
        ...
        if (headers.location.includes('.com/checkpoint/')) {
          ...
          console.log((""), (('')), `Please check your Facebook and click 'This was me" as you have login approvals turned on.'`);
...
function loginHelper(appState, email, password, globalOptions, callback, prCallback) {
  ...
  mainPromise
    .then(function() {
      console.log('Done logging in.'); return callback(null, api);
    })
    .catch(function(e) {
